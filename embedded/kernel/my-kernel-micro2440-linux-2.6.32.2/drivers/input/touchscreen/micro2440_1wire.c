 ...
 *
 * LCD-CPU one wire communication for Mini2440 from
...
static int init_timer_for_1wire(void)
{
	...
	TCNT_FOR_SAMPLE_BIT = pclk / 2 / (prescale1_value + 1) / SAMPLE_BPS - 1;
...
MODULE_DESCRIPTION("Mini2440 one-wire host and Touch Screen Driver");

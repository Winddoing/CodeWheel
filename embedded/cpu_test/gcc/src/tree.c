...
tree
build (VARGLIST(enum tree_code code))
     va_dcl
{
  FIRST_ARG(enum tree_code code)
  va_list p;
  register tree t;
  register int length;
  register int i;

  VA_START(p, code, enum tree_code);
...
tree
build_nt (VARGLIST(enum tree_code code))
     va_dcl
{
  FIRST_ARG(enum tree_code code)
  va_list p;
...
tree
build_parse_node (VARGLIST(enum tree_code code))
     va_dcl
{

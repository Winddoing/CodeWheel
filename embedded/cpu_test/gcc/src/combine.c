...
static rtx gen_rtx_combine (VARGLIST(enum rtx_code));  /* This is varargs.  */
...
/*VARARGS2*/
static rtx
gen_rtx_combine (VARGLIST(enum rtx_code code))
     va_dcl
{
  va_list p;
  FIRST_ARG(enum rtx_code code)
  enum machine_mode mode;
  int n_args;
  rtx args[3];
  int i, j;

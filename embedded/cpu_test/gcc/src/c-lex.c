...
/* Buffered-back input character; faster than using ungetcc.  */
...
position_after_white_space ()
{
  ...
  ungetcc (skip_white_space (c), finput);
}
...
#define TOTAL_PARTS ((HOST_BITS_PER_WIDE_INT / HOST_BITS_PER_CHAR) * 2 + 2)
	...
	*p = 0;
	...
	token_buffer[1] = c1 = getcc (finput);
	token_buffer[2] = 0;

...
#if defined (USG) || defined (NO_STAB_H) || defined(SPEC)
#include "gstab.h"  /* If doing DBX on sysV, use our own stab.h.  */
#else
#include /*<stab.h>*/ "gstab.h"  /* On BSD, use the system's stab.h.  */
#endif /* not USG */
...
void
asm_fprintf (VARGLIST(FILE *file))
     va_dcl
{
  va_list argptr;
  FIRST_ARG(FILE *file)

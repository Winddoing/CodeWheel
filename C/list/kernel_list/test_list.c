 ...
 *     Author		: winddoing
 *     Created Time	: 2018年10月30日 星期二 11时20分56秒
 *     Description	:
 *############################################################*/
...
int main(int argc, char **argv){
	...
	for(i=5; i!=0; --i){
		tmp= (kool_list *)malloc(sizeof(kool_list));
	...
	/* now you have a circularly linked list of items of type kool_list.
	...
	list_for_each(pos, &mylist.list){
		 ...
		 ** of type kool_list. But we need to access the item itself not the 
		 ...
		 **/
		tmp= list_entry(pos, kool_list, list);
		 ...
		 ** kool_list item it is embedded in!
		 **/

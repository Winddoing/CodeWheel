-- MySQL dump 10.11
--
-- Host: localhost    Database: wavedata
-- ------------------------------------------------------
...
DROP DATABASE IF EXISTS wavedata;
CREATE DATABASE wavedata;
use wavedata;
...
DROP TABLE IF EXISTS `voicedata`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
LOCK TABLES `voicedata` WRITE;
/*!40000 ALTER TABLE `voicedata` DISABLE KEYS */;
/*!40000 ALTER TABLE `voicedata` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-11-22  1:57:23
